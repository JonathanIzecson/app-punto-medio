...
public class RegistrarProductosFragment extends Fragment {
    ...
    public static RegistrarProductosFragment newInstance(String param1, String param2) {
        RegistrarProductosFragment fragment = new RegistrarProductosFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista = inflater.inflate(R.layout.fragment_registrar_productos, container, false);
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(getContext(),R.array.combo_proposito,android.R.layout.simple_spinner_item);
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(!txtTitulo.getText().toString().equals("") || !txtDescripcion.getText().toString().equals("")){
                    ...
                    String url = "http://192.168.100.40/WebService/WS_PROYECTO_REGISTRAR_PRODUCTO.php?encabezado=" + Titulo +
